...
def check_versions():
    ver = cef.GetVersion()
    print("[cef_tutorial.py] CEF Python {ver}".format(ver=ver["version"]))
    print("[cef_tutorial.py] Chromium {ver}".format(ver=ver["chrome_version"]))
    print("[cef_tutorial.py] CEF {ver}".format(ver=ver["cef_version"]))
    print("[cef_tutorial.py] Python {ver} {arch}".format(
